...
\subfigure[{\color{red}Unimodal-} zu {\color{blue}Bimodal}verteilung.
Dieser Transportplan ist eine ``unscharfe'' Version der Kurve
in Abbildung~\ref{mongekant:fig:optimal_transport}.%
\label{mongekant:fig:plan2}]{
...
Die Deckkraft der schwarzen Fläche ist proportional zu $\gamma(x,y)$.
...
\end{aligned}
\end{align*}
Schauen wir uns den Term %$\sup_{\xi, \eta} L(\xi, \eta)$
\begin{align*}
\sup_{\xi, \eta} L(\xi, \eta)
&=
\begin{cases}
