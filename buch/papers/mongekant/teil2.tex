...
\begin{figure}
\centering
\subfigure[Normal- zu Rayleigh-Verteilung\label{mongekant:fig:plan1}]{
\includegraphics[width=0.48\textwidth]{papers/mongekant/code/ot_map_1}
}\hfill
\subfigure[Unimodal- zu Bimodalverteilung\label{mongekant:fig:plan2}]{
\includegraphics[width=0.48\textwidth]{papers/mongekant/code/ot_map_2}
}
\caption{Beispiele für Transportpläne $\gamma(x,y)$,
wobei hier die Helligkeit an den Wert von $\gamma(x,y)$ gekoppelt ist.
