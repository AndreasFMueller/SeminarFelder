...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.4\linewidth]{papers/schall/figures/normal_sidepanels.png}
  \caption{Normale Lage mit abnehmender Temperatur $T(z)$}
  \label{fig:schall:normale_lage}
\end{subfigure}%
\hfill
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.4\linewidth]{papers/schall/figures/inversion_sidepanels.png}
  \caption{Inverse Lage mit zunehmender Temperatur $T(z)$}
  \label{fig:schall:inverse_lage}
\end{subfigure}
\vskip\baselineskip
\begin{figure}
\centering
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.4\linewidth]{papers/schall/figures/overlay_clean.png}
  \caption{Überlagerung normale und inverse Lage}
  \label{fig:schall:normale_lage}
\end{subfigure}%
\hfill
\begin{subfigure}{.5\textwidth}
  ...
  \label{fig:schall:inverse_lage}
\end{subfigure}
\caption{Schallausbreitung für eine normale und inverse Lage der Temperatur.}
\label{fig:schall:schallausbreitung_norm_inv_lage}
\end{figure}
