...
%
\subsubsection{Rand}
\input{chapters/120-topologie/fig/fig-rand.tex}%
...
Ein Unterteilungspunkt auf einer Kante eines Dreiecks fügt auch
...
Dann muss der Zyklus auch eine der halben Kanten enthalten.
Indem wir den Rand des Dreieck subtrahieren, welches die gleiche halbe
Kante enthält, verschwindet sowohl die neue Kante wie auch die
halbe Kante us dem Zyklus $z$.
...
Wir unterteilen jetzt das Dreieck $abc$ mit dem inneren Punkt $p$.
Es entstehen drei neue Dreiecke $abp$, $bcp$ und $cap$ und drei neue
Kanten $ap$, $bp$ und $cp$.
Wenn ein Zyklus im unterteilten $Z_1$ eine der neuen Kanten
enthält, dann muss er auch noch eine weitere solche Kanten enthalten.
Die beiden Kanten gehören zu genau einem der neuen Dreiecke.
Indem man den Rand dieses Dreiecks vom Zyklus subtrahiert, erhält
man einen homologen Zyklus, der die neuen Kanten nicht mehr braucht.

Als letztes Beispiel unterteilen wir ein Tetraeder $abcd$ mit
mit einem inneren Punkt $p$.
...
\input{chapters/120-topologie/fig/fig-torushomologie.tex}%
