...
Dieser Übergang zur Nichtlinearität des Vakuums wurde erstmals im Jahre 1951 in \mytodo{Quelle Fritz Sauter} von Fritz Sauter theoretisiert. % Paper von fritz sauer ist auf Wikipedia - Schwinger-limit verlinkt.
Später arbeitete Julian Schwinger die Idee von Sauter weiter aus, weshalb das Phänomen später nach ihm benannt wurde.
Da es sich hierbei um elektrische und magnetische Feldstärken im Bereich von $10^{18}\,\frac{\text{V}}{\text{m}}$ und $10^9\,\text{T}$ handelt, konnte dieses Limit bisher noch nicht gemessen werden. % TODO: Konnte nie gemessen werden, aber photonen-phototnen-streuung wurde in diesen Feldstärkenbereichen bereits beobachtet.
Entsprechend ist das Schwinger-Limit noch immer Bestandteil aktueller Forschungen. \mytodo{Quelle hierfür angeben} % TODO: z.B. Station of extreme light oder ATLAX experiment (Schwinger-Limit Wikipedia hat links)
Die Photonen-Photonen-Streuung wurde jedoch bereits beobachtet, was ein starkes Indiz dafür ist, dass das Schwinger-Limit tatsächlich existiert.
