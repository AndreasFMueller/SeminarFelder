\begin{tikzpicture}
  ...
  \begin{scope}[scale=\drawscale,blue]
    \draw[black,fill=lightblue] \pathA;
    \begin{scope}
      \clip \pathA;
  ...
  \begin{scope}[xshift=\boffset,scale=\drawscale,anchor=south west,color=red]
    \draw[black,fill=lightred] \pathB;
    \begin{scope}
      \clip \pathB;
