...
\begin{equation}
	...
	\left. \frac{\partial T}{\partial t}\right|{(i,j,n+\frac{1}{2})}
	\approx
	\frac{T_{i,j}^{n+1} - T_{i,j}^n}{\Delta t}.
\end{equation}
Dies entspricht der zeitlichen Änderungsrate von T am diskreten Gitterpunkt \((x_i, y_j, t_{n+\frac{1}{2})}\)
...
\begin{equation}
	\left. \frac{\partial^2 T}{\partial x^2} \right|{(i,j,n)} \approx
