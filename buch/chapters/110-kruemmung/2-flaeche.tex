...
%
% Algebraische Bianchi-Identität
%
\subsubsection{Algebraische Bianchi-Identität}
...
%
% Die differentielle Bianchi-Idenität
%
...
%
% Untermannigfaltigkeiten von R^3
%
...
$f$ lokal ein Diffeomorphismus zwischen $U$ und der Bildmenge $f(U)$
sein.
...
Sei die Fläche wieder durch die Abbildung $f\colon U\to\mathbb{R}^3$
...
Für jeden tangentialen Richtungsvektor $\vec{w}\in T_pM$ im Punkt $p$
