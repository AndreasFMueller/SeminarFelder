...
%
% Kovariante Ableitung für kontravariante Tensoren
%
...
\]
gilt.
Durch Auflösen nach dem ersten Term auf der rechten Seite erhält man
\begin{equation}
\langle \nabla_X\alpha,A\rangle
=
X
...
\biggr).
\end{align*}
Da dies für alle Vektoren $A$ und $X$ gelten muss, definieren wir die
kovariante Ableitung für 1-Formen wie folgt.
...
Term und $l$ und $s$ im rechten Term kann man erreichen, dass alle Terme
