...
So wurde für die Simulationen eine von Huygens Optics angepasste Version~\cite{particles:huygens_wavesim2d} des Open-Source Wellensimulators WaveSimulator2D~\cite{repo:wavesim2d} verwendet.
