...
Es resultiert die 2-Form
\[
F
= \frac{1}{2} F_{\mu\nu} \, dx^\mu \wedge dx^\nu,
\]
man beachte dabei die einsteinsche Summationskonvention von Definition~\ref{buch:koordinaten:tangentialvektoren:def:einsteinschesummenkonvention}.
...
Nun wenden wir die äussere Ableitung auf die 2-Form $F$ an, man beachte dabei Definition \ref{maxwell:hodge:kurzschreibweise}:
 \begin{align*}	
	...
	&- \phantom{\frac{1}{c}} \frac{\d B_2}{\d x^0} \, dx^{013} + \phantom{\frac{1}{c}} \frac{\d B_2}{\d x^2} \, dx^{123}
	 + \phantom{\frac{1}{c}} \frac{\d B_1}{\d x^0} \, dx^{023} + \phantom{\frac{1}{c}} \frac{\d B_1}{\d x^1} \, dx^{123},
\end{align*}
und fassen anschliessend alles zusammen zu
\begin{align*}
	dF =
...
In diesem Fall entsprechen sie genau den klassischen homogenen Maxwell-Gleichun\-gen
\begin{align*}
