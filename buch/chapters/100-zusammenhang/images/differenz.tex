...
\begin{scope}[yshift=5.5cm]
	...
	\node at (0,0) {\includegraphics[width=10.6cm]{differenz.jpg}};
...
\begin{scope}
	...
	\node at (0,0) {\includegraphics[width=10.6cm]{d06.jpg}};
	\coordinate (A) at (4.1,-1.3);
	%\coordinate (B) at (1.1,-0.5);
	\coordinate (B) at (-1.50,0.4);
	\draw[->,color=darkred,opacity=0.7,line width=1.4pt]
		(A) -- ++(B);
	\draw[->,color=darkred,opacity=0.7,line width=1.4pt]
		($(A)+(-2.55,-0.00)$) -- ++($(B)+(-0.05,-0.1)$);
	\node at (-4.8,2.1) {(b)\strut};
\end{scope}
\begin{scope}[yshift=-5.6cm]
	\clip (-5.3,-2.9) rectangle (5.3,2.5);
	\node at (0,0) {\includegraphics[width=10.6cm]{diffgedreht.jpg}};
	\node at (-1.8,-0.5) {$\gamma(t)$};
	\node at (0.1,-1.9) {$\dot{\gamma}(t)$};
