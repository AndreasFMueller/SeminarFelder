...
\input{chapters/040-green/fig/fig-quader.tex}%
...
Für das im Satz von Green angestrebte Resultat berechnen wird als
...
Eine $n$-dimensionale differenzierbare \emph{Mannigfaltigkeit mit Rand}
...
\begin{definition}[äussere Ableitung einer 1-Form auf $\mathbb{R}^2$]
...
\begin{definition}[äussere Ableitung einer 2-Form auf $M$]
