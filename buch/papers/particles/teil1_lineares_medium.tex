...
\index{Flussdichte, elektrische}%
\index{eletrisches Feld}%
\index{Feld, eletrisches}%
wird die Permittivität $\varepsilon$ beigezogen.
\index{Permittivitat@Permittivität}%
...
\index{magnetische Feldstarke@magnetische Feldstärke}%
\index{magnetische Flussdichte}%
\index{Flussdichte, magnetische}%
\index{Feldstarke, magnetische@Feldstärke, magnetische}%
...
%\label{particles:eq:lichtgeschwindigkeit}
\]
beträgt.
...
\index{Vakuum nichtlinear}%
\index{Nichtlinear!Vakuum}%
...
\index{Photonen-Photonen-Streuung}%
