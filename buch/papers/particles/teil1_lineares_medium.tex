...
Bei extrem hohen Feldstärken tritt ein Phänomen auf, wobei das Vakuum selbst nichtlinear wird. % TODO: Ist keine gegebenheit! (weniger sicher schreiben)
Dieser Übergang zur Nichtlinearität des Vakuums nennt man das \emph{Schwinger-Limit}\mytodo{Quellenangabe}, benannt nach Julian Schwinger, welcher 1951 dieses Phänomen erstmals theoretisierte. % TODO: Nein, wurde von Fritz Sauter entdeckt und schliesslich von schwinger näher charakterisiert. Paper von fritz sauer ist auf Wikipedia - Schwinger-limit verlinkt.
Da es sich hierbei um elektrische und magnetische Feldstärken im Bereich von $10^{18}\,\frac{\text{V}}{\text{m}}$ und $10^9\,\text{T}$ handelt, konnte dieses Limit bisher noch nicht konkret nachgewiesen oder gemessen werden. % TODO: Konnte nie gemessen werden, aber photonen-phototnen-streuung wurde in diesen Feldstärkenbereichen bereits beobachtet.
Es ist entsprechend noch immer Bestandteil aktueller Forschungen. \mytodo{Quelle hierfür angeben} % TODO: z.B. Station of extreme light oder ATLAX experiment (Schwinger-Limit Wikipedia hat links)
