...
Dies ist ähnlich der Updateformel~\eqref{parallelisierung:eq:update_formel} aus Kapitel~\ref{chapter:parallelisierung}, 
welche auch mit dem Kernel
\[
    \boldsymbol{D}_{xy}^2
    =
    \begin{pmatrix}
...
Hier werden jedoch die diagonalen Terme vernachlässigt, 
da nur die direkt benachbarten Zellen aufgrund der Lokalität der Feldgleichung berücksichtigt werden müssen.
Für den WaveSimulator2D können die diagonalen Terme jedoch nicht einfach vernachlässigt werden, 
da diese einen signifikanten Einfluss auf das Resultat haben.
Es wird daher der für unseren Fall verfeinerte Kernel
\[
    \mathbf{D}^2_{xy} = 
    \begin{pmatrix}
        0.066 &  0.184 & 0.066\\
    ...
    \end{pmatrix}
\]
verwendet, was zu der angepassten Wellengleichung 
\[
